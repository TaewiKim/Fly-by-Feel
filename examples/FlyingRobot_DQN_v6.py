...
class DQNAgent():
    ...
    # motor action
    def step(self, Dewe, serial, action):
        ...
        self.angle = serial.getSerialData()
        next_state = Dewe.channel_data
...
def main():
    ...
    s.readSerialStart()  # starts Teensy thread
    my_thread.start() # starts DEWE thread
